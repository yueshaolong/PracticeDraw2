...
public class Practice12PathEffectView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 第二处：DiscretePathEffect线条分段后随机偏移
        ...
        // 第四处：PathDashPathEffect使用path绘制虚线
        Path mpath = new Path();
        mpath.lineTo(20,-30);
        mpath.lineTo(40,0);
        mpath.close();
        PathDashPathEffect pathDashPathEffect = new PathDashPathEffect(mpath, 50,0, Style.MORPH);
